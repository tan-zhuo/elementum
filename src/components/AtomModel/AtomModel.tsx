...
import { CAMERA_FOV, cameraDistance } from './geometry'
...
function ViewerButton({ active, onClick, children, title }: ToggleProps) {
  return (
    <button
      type="button"
      onClick={onClick}
    ...
    >
      <div className="relative flex-1">
        <Canvas
          ...
          camera={{ position: [distance * 0.35, distance * 0.42, distance * 0.84], fov: CAMERA_FOV }}
          dpr={[1, 2]}
